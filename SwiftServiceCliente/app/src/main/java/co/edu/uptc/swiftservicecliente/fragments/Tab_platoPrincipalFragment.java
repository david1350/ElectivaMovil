...
public class Tab_platoPrincipalFragment extends Fragment{

    RecyclerView recyclerPlatillos;
    ArrayList<Platillo> listaPlatillosPrincipales;
    ArrayList<Platillo> listaOrden;

    public Tab_platoPrincipalFragment  (ArrayList<Platillo> Orden,ArrayList<Platillo> listaPlatillos ){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        PlatilloImagenAdapter platilloAdapter = new PlatilloImagenAdapter(listaPlatillosPrincipales);
