...
public class Tab_ensaladaFragment extends Fragment{
    ...
    public Tab_ensaladaFragment (ArrayList<Platillo> Orden,ArrayList<Platillo> listaPlatillos){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        PlatilloImagenAdapter platilloAdapter = new PlatilloImagenAdapter(listaEnsaladas);
