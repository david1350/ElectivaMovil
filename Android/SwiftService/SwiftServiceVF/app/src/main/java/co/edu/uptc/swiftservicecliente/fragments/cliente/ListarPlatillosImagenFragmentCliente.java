...
public class ListarPlatillosImagenFragmentCliente extends Fragment {

    RecyclerView recyclerPlatillos;
    ArrayList<Platillo> listaPlatillos;
    ArrayList<Platillo> listaOrden;

    public ListarPlatillosImagenFragmentCliente(ArrayList<Platillo> Orden, ArrayList<Platillo> listaPlatillos){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        PlatilloImagenAdapterCliente platilloAdapter = new PlatilloImagenAdapterCliente(listaPlatillos);

        platilloAdapter.setOnclickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Platillo p = listaPlatillos.get(recyclerPlatillos.getChildAdapterPosition(v));
