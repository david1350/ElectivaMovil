...
public class PlatilloPedidosAdapterCliente extends RecyclerView.Adapter<PlatilloPedidosAdapterCliente.PlatillosHolder>
implements View.OnClickListener{

    List<Pedido> listaPedidos;
    private View.OnClickListener listener;

    public PlatilloPedidosAdapterCliente(List<Pedido> listaPed) {
        this.listaPedidos = listaPed;
    }

    @Override
    public PlatillosHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View vista= LayoutInflater.from(parent.getContext()).inflate(R.layout.platillos_list_hechos_cliente,parent,false);
    ...
    public class PlatillosHolder extends RecyclerView.ViewHolder{
        ...
        TextView  txvFecha,txvNumeroPedido, txvProductos,txvObservaciones,txvEstado,txtvCosto;


        public PlatillosHolder(View itemView) {
            super(itemView);
            txvFecha = (TextView) itemView.findViewById(R.id.campoFechaPedidoCliente);
            txvNumeroPedido = (TextView) itemView.findViewById(R.id.campoIDpedidoCliente);
            txvProductos = (TextView) itemView.findViewById(R.id.campoProductosCliente);
            txvObservaciones = (TextView) itemView.findViewById(R.id.campoObservacionesHechasCliente);
            txvEstado = (TextView) itemView.findViewById(R.id.campoEstadoCliente);
            txtvCosto = (TextView) itemView.findViewById(R.id.campoCostoPedidoCliente);
