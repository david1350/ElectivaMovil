...
public class ListarPlatillosImagenFragment extends Fragment {

    RecyclerView recyclerPlatillos;
    ArrayList<Platillo> listaPlatillos;
    ArrayList<Platillo> listaOrden;

    public ListarPlatillosImagenFragment (ArrayList<Platillo> Orden,ArrayList<Platillo> listaPlatillos){
