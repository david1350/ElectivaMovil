...
public class PedidosHechosFragment extends Fragment
  implements Response.Listener<JSONObject>,Response.ErrorListener {
    ...
    public PedidosHechosFragment (int nm){
        this.numeroMesa = nm;
    }
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        etNumMesa = (TextView) v.findViewById(R.id.mesaPeidosHechos);
        etNumMesa.setText("MESA: " + numeroMesa);
        this.precio = 0;
        costoTotalHechos = (TextView) v.findViewById(R.id.campoCostoPedidosHechos);
    ...
    public void onResponse(JSONObject response) {
        ...
        try {
            ...
            PlatilloPedidosAdapter  adapter = new PlatilloPedidosAdapter(listaPedidos);
