...
public class PlatilloImagenAdapterCliente extends RecyclerView.Adapter<PlatilloImagenAdapterCliente.PlatillosHolder>
implements View.OnClickListener{

    List<Platillo> listaPlatillos;
    private View.OnClickListener listener;

    public PlatilloImagenAdapterCliente(List<Platillo> listaUsuarios) {
        this.listaPlatillos = listaUsuarios;
    }

    @Override
    public PlatillosHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View vista= LayoutInflater.from(parent.getContext()).inflate(R.layout.plaltillos_list_imagen_cliente,parent,false);
    ...
    public class PlatillosHolder extends RecyclerView.ViewHolder{
        ...
        public PlatillosHolder(View itemView) {
            super(itemView);
            txtNombre= (TextView) itemView.findViewById(R.id.campoListarNombreCliente);
            txtDescripcion= (TextView) itemView.findViewById(R.id.campoListarDescripcionCliente);
            txtPrecio = (TextView) itemView.findViewById(R.id.campoListarPrecioCliente);
            imagenConsultar = (ImageView)itemView.findViewById(R.id.campoListarImagenCliente);
