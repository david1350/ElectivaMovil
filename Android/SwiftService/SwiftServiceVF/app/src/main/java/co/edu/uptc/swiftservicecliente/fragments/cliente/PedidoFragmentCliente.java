...
public class PedidoFragmentCliente extends Fragment {
   ...
   int precio;
    ...
    PlatilloImagenAdapterCliente platilloAdapter;
   ...
   public PedidoFragmentCliente(ArrayList<Platillo> listaPlatillosPedido, int i){
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        View v  = inflater.inflate(R.layout.list_pedido_cliente, container, false);

        this.recyclerPlatillosPedido = (RecyclerView) v.findViewById(R.id.idRecyclerViewPedidoCliente);
        ...
        this.campoFecha = (TextView)v.findViewById(R.id.campoFechaCliente);
        this.campoFecha.setText("FECHA: " +  fecha);

        this.campoMesa = (TextView) v.findViewById(R.id.campoMesaCliente);

        this.campoMesa.setText("MESA: "  +  this.numeroMesa);

        this.campoObservaciones = (EditText)v.findViewById(R.id.campoObservacionesCliente);
        this.campoCostoTotal  =(TextView) v.findViewById(R.id.campoCostoTotalCliente);
        this.btnEnviarOrden = (Button) v.findViewById(R.id.btnEnviarOrdenCliente);
        request = Volley.newRequestQueue(getContext());
        this.precio = 0;


        platilloAdapter = new PlatilloImagenAdapterCliente(listaPlatillosPedido);
